...
const storeUrl = process.env.APP_URL;
const storeBaseUrl = storeUrl ? `${process.env.APP_URL}` : null
  ...
  return (
    <Head>
      ...
      <meta
        key="description"
        name="description"
        content={description || config.description + process.env.APP_URL}
      />
      <meta
        key="og:type"
        property="og:type"
      ...
      <meta
        ...
        content={
          ...
          description ??
          config.description + process.env.APP_URL
        }
      />
      <meta
        key="og:site_name"
      ...
      <meta
        key="og:url"
        property="og:url"
        content={(openGraph?.url) ? `${openGraph.url}` : `${process.env.APP_URL}`}
      ></meta>
      {openGraph?.locale && (
